...
Hexadecimal [16-Bits]
                             ...
                             18 ;;------------------------------------------------LICENSE NOTICE-------------------------------------------------------------------------
                             19 
                             20 ;; Include all CPCtelera constant definitions, macros and variables
...
Hexadecimal [16-Bits]
                             ...
                             32 
   0050                      33 _main::
                             34    ;; Disable firmware to prevent it from interfering with string drawing
   0050 CD 0E 01      [17]   35    call cpct_disableFirmware_asm
                             36 
   0053 0E 00         [ 7]   37    ld c, #0
   0055 CD 8B 00      [17]   38    call cpct_setVideoMode_asm
                             39    
   0058 21 40 00      [10]   40    ld   hl, #_g_pal
   005B 11 10 00      [10]   41    ld   de, #16
   005E CD 78 00      [17]   42    call cpct_setPalette_asm
                             43 
   0061 DD 21 00 C0   [14]   44    ld 		ix, #0xC000
   0065 11 00 40      [10]   45    ld 		de, #0x4000
   0068 CD 98 00      [17]   46    call 	cpct_miniload_asm
                             47 
   006B DD 21 94 06   [14]   48    ld 		ix, #0x0694
   006F 11 19 69      [10]   49    ld 		de, #0x6919
   0072 CD 98 00      [17]   50    call 	cpct_miniload_asm
   0075 C3 92 4F      [10]   51    jp 0x4F92
