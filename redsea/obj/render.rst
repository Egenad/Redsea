...
Hexadecimal [16-Bits]
                             ...
                             23 
   46A2 C0                   24 m_front_buffer: .db 0xC0
   46A3 80                   25 m_back_buffer:  .db 0x80
                             26 
                             27 
   46A4                      28 ren_newScene:
   46A4 CD A9 46      [17]   29    call ren_switchBuffers
                             30    ;;call ren_clearBackBuffer
   46A7 C9            [10]   31 ret
                             32 
                             33 
   46A8                      34 ren_clearBackBuffer:
                             35 
                             36    ;ld       a, (m_back_buffer)
                             37    ;ld       h, a
                             38    ;ld      de, #0
                             39    ;ld       l, e
                             40    ;ld      bc, #0x4000
                             41 
                             42    ;call cpct_memset_f64_asm
                             43 
   46A8 C9            [10]   44 ret
                             45 
   46A9                      46 ren_switchBuffers:
                             47 
   46A9 3A A3 46      [13]   48    ld    a, (m_back_buffer)
   46AC 47            [ 4]   49    ld    b, a 
   46AD 3A A2 46      [13]   50    ld    a, (m_front_buffer)
   46B0 32 A3 46      [13]   51    ld    (m_back_buffer), a 
   46B3 78            [ 4]   52    ld    a, b 
   46B4 32 A2 46      [13]   53    ld    (m_front_buffer), a
                             54 
   46B7 CB 38         [ 8]   55    srl   b
   46B9 CB 38         [ 8]   56    srl   b
   46BB 68            [ 4]   57    ld    l, b
   46BC C3 32 60      [10]   58    jp cpct_setVideoMemoryPage_asm
                             59 
                             60 
   46BF                      61 render_draw:
                             62 
                             63 	;;ld    de, #0xC000       ;;Start video memory
   46BF 3A A3 46      [13]   64 	ld     a, (m_back_buffer)
   46C2 57            [ 4]   65    ld     d, a
   46C3 1E 00         [ 7]   66    ld     e, #0
   46C5 DD 4E 00      [19]   67    ld     c, de_x(ix)         ;; C = Entity Y
   46C8 DD 46 01      [19]   68    ld     b, de_y(ix)         ;; B = Entity X
   46CB CD B5 61      [17]   69    call cpct_getScreenPtr_asm
                             70 
   46CE EB            [ 4]   71    ex    de, hl   ;; DE = memory pointer
                             72    ;;ld  a, de_c(ix)   ;; Color --> With Sprites its not necessary
                             73    ;;ld hl, #_hero_sp_00
   46CF DD 6E 04      [19]   74    ld  l, de_sp_l(ix)
   46D2 DD 66 05      [19]   75    ld  h, de_sp_h(ix)
   46D5 DD 46 03      [19]   76    ld  b, de_h(ix)   ;;de_h(ix)   ;; height
   46D8 DD 4E 02      [19]   77    ld  c, de_w(ix)   ;;de_w(ix)   ;; width
...
Hexadecimal [16-Bits]
   ...
   46DB CD EF 5E      [17]   80    call cpct_drawSprite_asm      ;; Now draw Sprites
   46DE C9            [10]   81 	ret
                             82 
   46DF                      83 calcule_clear:
   46DF 3A A3 46      [13]   84    ld     a, (m_back_buffer)
   46E2 57            [ 4]   85    ld     d, a
   46E3 1E 00         [ 7]   86    ld     e, #0
   46E5 DD 4E 00      [19]   87    ld     c, de_x(ix)         ;; C = Entity Y
   46E8 0D            [ 4]   88    dec c
   46E9 F2 ED 46      [10]   89    jp p, no_es_negativo
   46EC 0C            [ 4]   90    inc c 
   46ED                      91    no_es_negativo:
   46ED DD 46 01      [19]   92    ld     b, de_y(ix)         ;; B = Entity X
   46F0 C9            [10]   93 ret
                             94 
   46F1                      95 render_clear:
                             96    
   46F1 CD DF 46      [17]   97    call calcule_clear
   46F4 CD B5 61      [17]   98    call cpct_getScreenPtr_asm
                             99 
                            100 
   46F7 EB            [ 4]  101    ex de, hl
                            102 
                            103    
   46F8 DD 4E 02      [19]  104    ld c, de_w(ix)
   46FB 0C            [ 4]  105    inc c
   46FC 0C            [ 4]  106    inc c 
   46FD DD 46 03      [19]  107    ld b, de_h(ix)
   4700 3E 00         [ 7]  108    ld a, #0x0
                            109 
   4702 CD E3 60      [17]  110    call cpct_drawSolidBox_asm
                            111 
   4705 C9            [10]  112    ret
                            113 
   4706                     114 render_clear_asset:
                            115 
   4706 CD DF 46      [17]  116    call calcule_clear
   4709 05            [ 4]  117    dec b
   470A CD B5 61      [17]  118    call cpct_getScreenPtr_asm
                            119 
   470D EB            [ 4]  120    ex de, hl
                            121    
   470E DD 4E 02      [19]  122    ld c, de_w(ix)
   4711 0C            [ 4]  123    inc c
   4712 0C            [ 4]  124    inc c 
   4713 DD 46 03      [19]  125    ld b, de_h(ix)
   4716 04            [ 4]  126    inc b
   4717 04            [ 4]  127    inc b 
   4718 3E 00         [ 7]  128    ld a, #0x0
                            129 
   471A CD E3 60      [17]  130    call cpct_drawSolidBox_asm
                            131 
   471D C9            [10]  132 ret
...
Hexadecimal [16-Bits]
                            ...
                            133 
   471E                     134 erase_inbothBuffers:
                            135 
   471E 57            [ 4]  136    ld     d, a
   471F 1E 00         [ 7]  137    ld     e, #0
   4721 DD 4E 00      [19]  138    ld     c, de_x(ix)         ;; C = Entity Y
   4724 DD 46 01      [19]  139    ld     b, de_y(ix)         ;; B = Entity X
   4727 CD B5 61      [17]  140    call cpct_getScreenPtr_asm
                            141 
   472A EB            [ 4]  142    ex de, hl
                            143    
   472B DD 4E 02      [19]  144    ld c, de_w(ix)
   472E DD 46 03      [19]  145    ld b, de_h(ix)
   4731 3E 00         [ 7]  146    ld a, #0x0
                            147 
   4733 CD E3 60      [17]  148    call cpct_drawSolidBox_asm
                            149 
   4736 C9            [10]  150 ret
                            151 
   4737                     152 render_clear_asset_both:
   4737 3E C0         [ 7]  153    ld     a, #0xC0
   4739 CD 1E 47      [17]  154    call erase_inbothBuffers
   473C 3E 80         [ 7]  155    ld     a, #0x80
   473E CD 1E 47      [17]  156    call erase_inbothBuffers
   4741 C9            [10]  157 ret
