...
Hexadecimal [16-Bits]
                             ...
                             25 
   51B9 88                   26 reloj: .db #0x88 
                             27 
                             28 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             29 ;;;;;;;;;;;INIT_NEXTLEVEL;;;;;;;;;;;;;;;
                             30 ;;;;;;;;Show next level screen;;;;;;;;;;
                             31 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             32 
                             33 
   51BA                      34 init_nextLevel:
                             35 
   51BA 21 C9 42      [10]   36 	ld hl, #_menu_pack_end 	;;Load here the tilemap you want
   51BD CD 8B 4F      [17]   37 	call DecompressTilemap
                             38 
   51C0 3E C0         [ 7]   39 	ld a, #0xC0
   51C2 CD E2 48      [17]   40 	call drawTileMap
                             41 
   51C5 3E 80         [ 7]   42 	ld a, #0x80
   51C7 CD E2 48      [17]   43 	call drawTileMap  ;;call menu tilemap
                             44 
   51CA 3E C0         [ 7]   45 	ld a, #0xC0
   51CC CD E6 51      [17]   46 	call draw_text_sp2
                             47 
   51CF 3E 80         [ 7]   48 	ld a, #0x80
   51D1 CD E6 51      [17]   49 	call draw_text_sp2
                             50 
   51D4 3A B9 51      [13]   51 	ld a, (reloj)
                             52 
   51D7                      53 initeando2:
                             54 
   51D7 76            [ 4]   55 	halt
                             56 
   51D8 F5            [11]   57 	push af
   51D9 CD 8B 60      [17]   58 	call cpct_waitVSYNC_asm
   51DC F1            [10]   59 	pop af
                             60 
   51DD 3D            [ 4]   61 	dec a
                             62 
   51DE 20 F7         [12]   63 	jr nz, initeando2
   51E0 3E 88         [ 7]   64 	ld a, #0x88
   51E2 32 B9 51      [13]   65 	ld (reloj), a
                             66 
   51E5 C9            [10]   67 ret
                             68 
   51E6                      69 draw_text_sp2:
                             70 
   51E6 F5            [11]   71 	push af
                             72 
   51E7 57            [ 4]   73 	ld     d, a
   51E8 1E 00         [ 7]   74 	ld     e, #0
   51EA 0E 17         [ 7]   75 	ld     c, #0x17         		;; C = Title X
   51EC 06 45         [ 7]   76    	ld     b, #0x45         		;; B = Title Y
   51EE CD B5 61      [17]   77    	call cpct_getScreenPtr_asm
                             78 
   51F1 EB            [ 4]   79    	ex    de, hl   					;; DE = memory pointer
...
Hexadecimal [16-Bits]
                             ...
                             80 
   51F2 21 A4 06      [10]   81 	ld hl, #_nextlevel_text_sp_0
   51F5 06 0C         [ 7]   82    	ld  b, #0x0C 	;;height
   51F7 0E 22         [ 7]   83    	ld  c, #0x22 	;;width
                             84 
   51F9 CD EF 5E      [17]   85    	call cpct_drawSprite_asm
                             86 
                             87 
   51FC F1            [10]   88    	pop af
                             89 
   51FD 57            [ 4]   90    	ld     d, a
   51FE 1E 00         [ 7]   91 	ld     e, #0
   5200 0E 17         [ 7]   92 	ld     c, #0x17         		;; C = Title X
   5202 06 69         [ 7]   93    	ld     b, #0x69         		;; B = Title Y
   5204 CD B5 61      [17]   94    	call cpct_getScreenPtr_asm
                             95 
   5207 EB            [ 4]   96    	ex    de, hl   					;; DE = memory pointer
                             97 
   5208 21 3C 08      [10]   98 	ld hl, #_nextlevel_text_sp_1
   520B 06 0C         [ 7]   99    	ld  b, #0x0C 	;;height
   520D 0E 22         [ 7]  100    	ld  c, #0x22 	;;width
                            101 
   520F CD EF 5E      [17]  102    	call cpct_drawSprite_asm
   5212 C9            [10]  103 ret
