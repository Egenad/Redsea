...
Hexadecimal [16-Bits]
                             ...
                             26 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             27 ;;;;;;;;;;;INIT_CONTROLS;;;;;;;;;;;;;;;;
                             28 ;;;;;;;;Show controls screen;;;;;;;;;;;;
                             29 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             30 
   464C                      31 init_controls:
                             32 
   464C 3E C0         [ 7]   33 	ld a, #0xC0
   464E CD E2 48      [17]   34 	call drawTileMap
                             35 
   4651 3E 80         [ 7]   36 	ld a, #0x80
   4653 CD E2 48      [17]   37 	call drawTileMap
                             38 
   4656 3E C0         [ 7]   39 	ld     a, #0xC0
   4658 CD 75 46      [17]   40 	call show_controls_sp
                             41 
   465B 3E 80         [ 7]   42    	ld     a, #0x80
   465D CD 75 46      [17]   43    	call show_controls_sp
                             44 
   4660                      45    	show_controls:
                             46 
   4660 CD 8B 60      [17]   47    	call cpct_waitVSYNC_asm
   4663 CD A4 46      [17]   48 	call ren_newScene
   4666 CD 47 49      [17]   49 	call changeLocation
                             50 
   4669 CD D1 61      [17]   51    	call cpct_scanKeyboard_asm 		;; Scan keyboard
   466C 21 05 80      [10]   52 	ld hl, #Key_Space				;; check space key
   466F CD 9D 56      [17]   53 	call cpct_isKeyPressed_asm
                             54 
   4672 28 EC         [12]   55    	jr z, show_controls
                             56 
   4674 C9            [10]   57 ret
                             58 
                             59 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             60 ;;;;;;;;;;;SHOW_CONTROLS_SP;;;;;;;;;;;;;
                             61 ;;;;;;;Draw sprite controls screen;;;;;;
                             62 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             63 
   4675                      64 show_controls_sp:
                             65 
   4675 F5            [11]   66 	push af
                             67 
   4676 57            [ 4]   68 	ld     d, a
   4677 1E 00         [ 7]   69 	ld     e, #0
   4679 0E 14         [ 7]   70 	ld     c, #0x14         		;; C = Title X
   467B 06 30         [ 7]   71    	ld     b, #0x30         		;; B = Title Y
   467D CD B5 61      [17]   72    	call cpct_getScreenPtr_asm
                             73 
   4680 EB            [ 4]   74    	ex    de, hl   					;; DE = memory pointer
                             75 
   4681 21 AD 1D      [10]   76 	ld hl, #_controls_sp
   4684 06 38         [ 7]   77    	ld  b, #0x38	;;height
   4686 0E 27         [ 7]   78    	ld  c, #0x27	;;width
                             79 
...
Hexadecimal [16-Bits]
   ...
   4688 CD EF 5E      [17]   80    	call cpct_drawSprite_asm
                             81 
   468B F1            [10]   82    	pop af
                             83 
   468C 57            [ 4]   84    	ld     d, a
   468D 1E 00         [ 7]   85 	ld     e, #0
   468F 0E 14         [ 7]   86 	ld     c, #0x14         		;; C = Title X
   4691 06 80         [ 7]   87    	ld     b, #0x80         		;; B = Title Y
   4693 CD B5 61      [17]   88    	call cpct_getScreenPtr_asm
                             89 
   4696 EB            [ 4]   90    	ex    de, hl   					;; DE = memory pointer
                             91 
   4697 21 E4 0D      [10]   92 	ld hl, #_gameover_text_sp_1
   469A 06 0D         [ 7]   93 	ld  b, #0x0D	;;height
   469C 0E 28         [ 7]   94    	ld  c, #0x28	;;width
                             95 
   469E CD EF 5E      [17]   96    	call cpct_drawSprite_asm
   46A1 C9            [10]   97 ret
