...
Hexadecimal [16-Bits]
                             ...
                             18 ;;------------------------------------------------LICENSE NOTICE-------------------------------------------------------------------------
                             19 
                             20 .globl init_controls
                             21 .globl _controls_sp
...
Hexadecimal [16-Bits]
                             ...
                             25 
                             26 
   489F C0                   27 location: .db #0xC0
                             28 
   48A0                      29 GetScreenForTitle:
   48A0 57            [ 4]   30 	ld     d, a
   48A1 1E 00         [ 7]   31 	ld     e, #0
   48A3 0E 11         [ 7]   32 	ld     c, #0x11         		;; C = Title X
   48A5 06 40         [ 7]   33    	ld     b, #0x40         		;; B = Title Y
   48A7 CD B5 61      [17]   34    	call cpct_getScreenPtr_asm
                             35 
   48AA EB            [ 4]   36    	ex    de, hl   					;; DE = memory pointer
                             37 
   48AB 21 07 27      [10]   38 	ld hl, #_title_sp_0
   48AE 06 0C         [ 7]   39    	ld  b, #0x0C 	;;height
   48B0 0E 2E         [ 7]   40    	ld  c, #0x2E 	;;width
                             41 
   48B2 CD EF 5E      [17]   42    	call cpct_drawSprite_asm
   48B5 C9            [10]   43 ret
                             44 
   48B6                      45 GetScreenForTitle1:
   48B6 57            [ 4]   46 	ld     d, a
   48B7 1E 00         [ 7]   47 	ld     e, #0
   48B9 0E 0D         [ 7]   48 	ld     c, #0x0D         		;; C = Title X
   48BB 06 65         [ 7]   49    	ld     b, #0x65         		;; B = Title Y
   48BD CD B5 61      [17]   50    	call cpct_getScreenPtr_asm
                             51 
   48C0 EB            [ 4]   52    	ex    de, hl   					;; DE = memory pointer
                             53 
   48C1 21 2F 29      [10]   54 	ld hl, #_title_sp_1
   48C4 06 0C         [ 7]   55    	ld  b, #0x0C 	;;height
   48C6 0E 2E         [ 7]   56    	ld  c, #0x2E 	;;width
                             57 
   48C8 CD EF 5E      [17]   58    	call cpct_drawSprite_asm
   48CB C9            [10]   59 ret
                             60 
   48CC                      61 GetScreenForTitle2:
   48CC 57            [ 4]   62 	ld     d, a
   48CD 1E 00         [ 7]   63 	ld     e, #0
   48CF 0E 0D         [ 7]   64 	ld     c, #0x0D         		;; C = Title X
   48D1 06 75         [ 7]   65    	ld     b, #0x75         		;; B = Title Y
   48D3 CD B5 61      [17]   66    	call cpct_getScreenPtr_asm
                             67 
   48D6 EB            [ 4]   68    	ex    de, hl   					;; DE = memory pointer
                             69 
   48D7 21 57 2B      [10]   70 	ld hl, #_title_sp_2
   48DA 06 09         [ 7]   71    	ld  b, #0x9 	;;height
   48DC 0E 2E         [ 7]   72    	ld  c, #0x2E 	;;width
                             73 
   48DE CD EF 5E      [17]   74    	call cpct_drawSprite_asm
   48E1 C9            [10]   75 ret
                             76 
   48E2                      77 drawTileMap:
   48E2 67            [ 4]   78 	ld h, a
   48E3 3E 00         [ 7]   79 	ld a, #0x0
...
Hexadecimal [16-Bits]
   ...
   48E5 6F            [ 4]   80 	ld l, a 
   48E6 11 40 00      [10]   81 	ld de, #tilemap_ptr
   48E9 CD 8F 5F      [17]   82 	call cpct_etm_drawTilemap4x8_ag_asm
   48EC C9            [10]   83 ret
                             84 
                             85 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             86 ;;;;;;;;;;;;;;;;;;;;;;;;; INIT_MENU ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             87 ;;;;;;;;;;;;;;;; Initalize game showng title ;;;;;;;;;;;;;;;;;;;;;;
                             88 ;;;;;;;;;; Until dont press 1 dont come back to main loop ;;;;;;;;;
                             89 ;;;;;;;;;;;;;; Destroy registers: A, DE, BC, HL ;;;;;;;;;;;;;;;;;;;
                             90 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             91 
   48ED                      92 init_menu:
                             93 
   48ED                      94 	Reset_menu:
                             95 
   48ED 3E C0         [ 7]   96 	ld a, #0xC0
   48EF CD E2 48      [17]   97 	call drawTileMap
                             98 
   48F2 3E 80         [ 7]   99 	ld a, #0x80
   48F4 CD E2 48      [17]  100 	call drawTileMap
                            101 
   48F7 3E C0         [ 7]  102 	ld     a, #0xC0
   48F9 CD A0 48      [17]  103 	call GetScreenForTitle
                            104 
   48FC 3E 80         [ 7]  105    	ld     a, #0x80
   48FE CD A0 48      [17]  106    	call GetScreenForTitle
                            107 
   4901 3E C0         [ 7]  108    	ld     a, #0xC0
   4903 CD B6 48      [17]  109 	call GetScreenForTitle1
                            110 
   4906 3E 80         [ 7]  111    	ld     a, #0x80
   4908 CD B6 48      [17]  112    	call GetScreenForTitle1
                            113 
   490B 3E C0         [ 7]  114    	ld     a, #0xC0
   490D CD CC 48      [17]  115 	call GetScreenForTitle2
                            116 
   4910 3E 80         [ 7]  117    	ld     a, #0x80
   4912 CD CC 48      [17]  118    	call GetScreenForTitle2	
                            119 
                            120 
   4915                     121 	Init: 							;; Infinite Loop until player press 1 or 2
                            122 
   4915 CD 8B 60      [17]  123 	   	call cpct_waitVSYNC_asm
   4918 CD A4 46      [17]  124 		call ren_newScene
   491B CD 47 49      [17]  125 		call changeLocation
                            126 
   491E CD D1 61      [17]  127 		call cpct_scanKeyboard_asm 		;;Scan keyboard
   4921 21 08 02      [10]  128 		ld hl, #Key_2					;;Check key 2 -> controls screen
   4924 CD 9D 56      [17]  129 		call cpct_isKeyPressed_asm
                            130 
   4927 28 12         [12]  131 		jr z, not_show_menu
                            132 
   4929 21 C9 42      [10]  133 		ld   hl, #_menu_pack_end
   492C CD 8B 4F      [17]  134   		call DecompressTilemap
...
Hexadecimal [16-Bits]
                            ...
                            135 
   492F CD 4C 46      [17]  136 		call init_controls
                            137 
   4932 21 40 41      [10]  138 		ld   hl, #_menu2_pack_end
   4935 CD 8B 4F      [17]  139 		call DecompressTilemap
                            140 
   4938 C3 ED 48      [10]  141 		jp Reset_menu
                            142 
   493B                     143 		not_show_menu:
                            144 
   493B CD D1 61      [17]  145 		call cpct_scanKeyboard_asm 		;;Scan keyboard
   493E 21 08 01      [10]  146 		ld hl, #Key_1					;;Check key 1 -> play game
   4941 CD 9D 56      [17]  147 		call cpct_isKeyPressed_asm
                            148 
   4944 28 CF         [12]  149 	jr z, Init
                            150 
   4946 C9            [10]  151 ret
                            152 
   4947                     153 changeLocation:
   4947 3A A3 46      [13]  154 	ld a, (m_back_buffer)
   494A 32 9F 48      [13]  155 	ld (location), a
   494D C9            [10]  156 ret
