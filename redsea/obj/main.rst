...
Hexadecimal [16-Bits]
                             ...
                             31 
                     0040    32 decompress_buffer     = 0x040
                     0654    33 levelmaxsize          = 0x654
                     0693    34 decompress_buffer_end = decompress_buffer + levelmaxsize - 1
                     0040    35 tilemap_ptr 		  = decompress_buffer + 0
                     0234    36 tileset_ptr 		  = decompress_buffer + 500
                             37 
   4F60 30                   38 contf1:  .db #0x30
   4F61 30                   39 max_cont_f1: .db #0x30
   4F62 30                   40 contf2:  .db #0x30
   4F63 30                   41 max_cont_f2: .db #0x30	
   4F64 30                   42 contf3:  .db #0x30	
   4F65 30                   43 max_cont_f3: .db #0x30	
   4F66 0C                   44 unavariable: .db #12
   4F67 0C                   45 otravariable: .db #12
                             46 
                             47 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             48 ;;;;;;;;;;;;;;;; ISR ;;;;;;;;;;;;;;;;;;;;
                             49 ;;;; Method to control interruptions ;;;;
                             50 ;; So music is not affected by process ;;
                             51 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             52 
   4F68                      53 isr::
                             54 	
   4F68 08            [ 4]   55 	ex af, af'
   4F69 D9            [ 4]   56 	exx
   4F6A F5            [11]   57 	push af
   4F6B C5            [11]   58 	push bc
   4F6C D5            [11]   59 	push de
   4F6D E5            [11]   60 	push hl
   4F6E FD E5         [15]   61 	push iy 
                             62 
   4F70 3A 66 4F      [13]   63 	ld a, (unavariable)
   4F73 3D            [ 4]   64 	dec a
   4F74 32 66 4F      [13]   65 	ld (unavariable), a
   4F77 20 09         [12]   66 	jr nz, volver
   4F79 CD C8 56      [17]   67 		call cpct_akp_musicPlay_asm
   4F7C 3A 67 4F      [13]   68 		ld a, (otravariable) 
   4F7F 32 66 4F      [13]   69 		ld(unavariable), a 
   4F82                      70 	volver:
   4F82 FD E1         [14]   71 	pop iy
   4F84 E1            [10]   72 	pop hl
   4F85 D1            [10]   73 	pop de
   4F86 C1            [10]   74 	pop bc 
   4F87 F1            [10]   75 	pop af
   4F88 D9            [ 4]   76 	exx
   4F89 08            [ 4]   77 	ex af, af'
   4F8A C9            [10]   78 	ret 
                             79 
                             80 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             81 ;;;;;;;; DECOMPRESSTILEMAP ;;;;;;;;;
                             82 ;; Decompress tilemap load in  Hl ;;
                             83 ;;;;;;;;;;; Input: HL ;;;;;;;;;;;;;;
                             84 ;;;;;;; Destroy registers: DE ;;;;;;
                             85 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                             ...
                             86 
   4F8B                      87 DecompressTilemap:
   4F8B 11 93 06      [10]   88 	ld   de, #decompress_buffer_end
   4F8E CD 93 60      [17]   89   	call cpct_zx7b_decrunch_s_asm 		;; Decompress tilemap
   4F91 C9            [10]   90 ret
                             91 
                             92 
                             93 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             94 ;;;;;;;;;;; MAIN PROGRAM ;;;;;;;;;;;
                             95 ;;; Generate, updates and desroys ;;
                             96 ;;; all game's objects ;;;;;;;;;;;;;
                             97 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             98 
   4F92                      99 _main::
                            100 
   4F92 31 00 80      [10]  101 	ld   sp, #0x8000 					;; Change cue position, so there is no problem with secundary buffer
   4F95 CD D3 60      [17]  102 	call cpct_disableFirmware_asm
   4F98 0E 00         [ 7]  103    	ld    c, #0
   4F9A CD 7E 60      [17]  104   	call cpct_setVideoMode_asm
                            105 
   4F9D 21 EF 39      [10]  106   	ld   hl, #_hero_pal
   4FA0 11 10 00      [10]  107   	ld   de, #16
   4FA3 CD A9 56      [17]  108   	call cpct_setPalette_asm
                            109 
   4FA6 01 14 19      [10]  110   	ld   bc, #0x1914
   4FA9 11 14 00      [10]  111   	ld   de, #_level0_W
   4FAC 21 34 02      [10]  112   	ld   hl, #tileset_ptr
                            113 
   4FAF CD 02 62      [17]  114   	call cpct_etm_setDrawTilemap4x8_ag_asm
                            115 
                            116 	;; Edges to black
                            117 
   4FB2 2E 10         [ 7]  118   	ld l, #16
   4FB4 3E 14         [ 7]  119   	ld a, #20
   4FB6 67            [ 4]  120   	ld h, a 
   4FB7 CD BC 56      [17]  121   	call cpct_setPALColour_asm
                            122 
                            123   	;;Change interruptions counter
                            124 
   4FBA 3E 06         [ 7]  125 	ld a, #6
   4FBC 32 67 4F      [13]  126   	ld (otravariable), a
   4FBF 32 66 4F      [13]  127   	ld (unavariable), a
                            128 
                            129    	;;Music
                            130 
   4FC2 21 68 4F      [10]  131   	ld hl, #isr
   4FC5 CD 75 56      [17]  132   	call cpct_setInterruptHandler_asm
                            133 
   4FC8                     134 resetted:
                            135 
   4FC8 11 1F 6A      [10]  136 	ld de, #_true_theme
   4FCB CD D2 5D      [17]  137     call cpct_akp_musicInit_asm
                            138 
   4FCE 21 40 41      [10]  139   	ld   hl, #_menu2_pack_end
   4FD1 CD 8B 4F      [17]  140 	call DecompressTilemap
...
Hexadecimal [16-Bits]
                            ...
                            141 
   4FD4 CD ED 48      [17]  142   	call init_menu
                            143 
                            144   	;Create first enemies
   4FD7 CD D7 4E      [17]  145 	call ent_start_level_1
                            146 	
   4FDA                     147 resetted_win:
                            148 
                            149   	;;Change interruptions counter
                            150 
   4FDA 3E 06         [ 7]  151   	ld a, #6
   4FDC 32 67 4F      [13]  152   	ld (otravariable), a
   4FDF 32 66 4F      [13]  153   	ld (unavariable), a
                            154 
                            155   	;;Game Initializing
                            156 
   4FE2 21 9E 44      [10]  157   	ld   hl, #_level0_pack_end
   4FE5 CD 8B 4F      [17]  158   	call DecompressTilemap
                            159 
   4FE8 11 DB 63      [10]  160   	ld de, #_main_theme
   4FEB CD D2 5D      [17]  161     call cpct_akp_musicInit_asm
                            162 
                            163     ;;Initializing TILEMAP in both buffer
                            164 
   4FEE 3E C0         [ 7]  165     ld a, #0xC0
   4FF0 CD E2 48      [17]  166 	call drawTileMap
   4FF3 3E C0         [ 7]  167 	ld a, #0xC0
   4FF5 CD A3 51      [17]  168 	call draw_Enemy_score
                            169 
   4FF8 3E 80         [ 7]  170    	ld a, #0x80
   4FFA CD E2 48      [17]  171 	call drawTileMap
   4FFD 3E 80         [ 7]  172 	ld a, #0x80
   4FFF CD A3 51      [17]  173 	call draw_Enemy_score
                            174 
                            175 	;;Initializing shooting sound
                            176 
   5002 11 48 6F      [10]  177 	ld de, #_shootSFX
   5005 CD 5E 5E      [17]  178 	call cpct_akp_SFXInit_asm
                            179 
                            180 
   5008                     181 loop:
                            182 
                            183   	;;CREATE ENEMIES
   5008 3A 1A 52      [13]  184 	ld a, (level)
   500B 3D            [ 4]  185 	dec a
   500C 28 36         [12]  186 	jr z, no_create_enemies ;dont create if level 1
                            187 
                            188 		;;Enemies Type 1
   500E 3A 60 4F      [13]  189 		ld a, (contf1)
   5011 3D            [ 4]  190 		dec a
   5012 20 09         [12]  191 		jr nz, no_create_enemies_f1
                            192 
   5014 CD C0 4A      [17]  193 			call ent_new_type1
   5017 3A 61 4F      [13]  194 			ld a, (max_cont_f1)
   501A 32 61 4F      [13]  195 			ld (max_cont_f1), a
...
Hexadecimal [16-Bits]
                            ...
                            196 
   501D                     197 		no_create_enemies_f1:
   501D 32 60 4F      [13]  198 		ld (contf1), a
                            199 
                            200 		;;Enemies Type 2
   5020 3A 62 4F      [13]  201 		ld a, (contf2)
   5023 3D            [ 4]  202 		dec a
   5024 20 09         [12]  203 		jr nz, no_create_enemies_f2
                            204 
   5026 CD E1 4A      [17]  205 			call ent_new_type2
   5029 3A 63 4F      [13]  206 			ld a, (max_cont_f2)
   502C 32 63 4F      [13]  207 			ld (max_cont_f2), a
                            208 
   502F                     209 		no_create_enemies_f2:
   502F 32 62 4F      [13]  210 		ld (contf2), a
                            211 
                            212 		;;Enemies Type 3
   5032 3A 64 4F      [13]  213 		ld a, (contf3)
   5035 3D            [ 4]  214 		dec a
   5036 20 09         [12]  215 		jr nz, no_create_enemies_f3
                            216 
   5038 CD 12 4B      [17]  217 			call ent_new_type3
   503B 3A 65 4F      [13]  218 			ld a, (max_cont_f3)
   503E 32 65 4F      [13]  219 			ld (max_cont_f3), a
                            220 
   5041                     221 		no_create_enemies_f3:
   5041 32 64 4F      [13]  222 		ld (contf3), a
                            223 
   5044                     224 	no_create_enemies:
                            225 
                            226 	;;ENEMIES
                            227 
   5044 21 A6 4B      [10]  228 	ld hl, #ent_clear
   5047 CD 02 4E      [17]  229 	call ent_doForAll
   504A 21 9F 4B      [10]  230 	ld hl, #ent_update
   504D CD 02 4E      [17]  231 	call ent_doForAll
                            232 
                            233 	;;SHOOT SFX
                            234 
   5050 CD 84 51      [17]  235 	call checkShooted
                            236 
   5053                     237 	not_shooted:
                            238 
   5053 21 9C 4B      [10]  239 	ld hl, #ent_draw
   5056 CD 02 4E      [17]  240 	call ent_doForAll
                            241 
                            242 	;;CABIN
                            243 
   5059 DD 21 AD 47   [14]  244 	ld ix, #camarote
   505D CD E8 47      [17]  245 	call ob_draw
                            246 
                            247 	;;BULLETS
                            248 
   5060 21 55 45      [10]  249 	ld hl, #bul_clear
   5063 CD C0 45      [17]  250 	call bul_doForAll
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 65.
Hexadecimal [16-Bits]



   5066 21 58 45      [10]  251 	ld hl, #bul_update
   5069 CD C0 45      [17]  252 	call bul_doForAll
   506C 21 5F 45      [10]  253 	ld hl, #bul_draw
   506F CD C0 45      [17]  254 	call bul_doForAll
                            255 
                            256 	;;OBSTACLES
                            257 
   5072 CD EB 47      [17]  258 	call ob_draw_obstacles
                            259 
                            260 	;; MAST 
                            261 
   5075 DD 21 A6 47   [14]  262 	ld ix, #mastil
   5079 CD E8 47      [17]  263 	call ob_draw
                            264 
                            265 	;;ENEMY WINDOW
                            266 
   507C DD 21 89 4A   [14]  267 	ld ix, #enemy_window
   5080 CD BC 4B      [17]  268 	call ent_updEnemy2
   5083 CD 9C 4B      [17]  269 	call ent_draw
                            270 
                            271 	;;PLAYER
                            272 
   5086 DD 21 1D 52   [14]  273 	ld ix, #hero_data
   508A CD 3B 52      [17]  274 	call pl_clear
   508D CD 34 52      [17]  275 	call pl_update
   5090 CD 31 52      [17]  276 	call pl_draw
                            277 
   5093 DD 21 27 52   [14]  278 	ld ix, #shoot_data
   5097 CD 3F 52      [17]  279 	call pl_clear_mira
   509A CD 34 52      [17]  280 	call pl_update
   509D CD 31 52      [17]  281 	call pl_draw
                            282 
                            283 	;;SCORE AND LIFE
   50A0 CD AD 54      [17]  284 	call draw_Lifes
   50A3 CD F5 53      [17]  285    	call draw_Score
                            286 
   50A6 CD 8B 60      [17]  287 	call cpct_waitVSYNC_asm
   50A9 CD A4 46      [17]  288    	call ren_newScene
                            289 
   50AC C3 08 50      [10]  290 	jp loop
                            291 
                            292 
   50AF                     293 reset_game:
                            294 
                            295 	;RESET THE GAME TO ITS DEFAULT VALUES
                            296 	;;Player
   50AF CD A2 55      [17]  297 	call reset_player
                            298 	;;Enemies
   50B2 CD A1 4E      [17]  299 	call reset_enemies
                            300 	;;Bullets
   50B5 CD DF 45      [17]  301 	call reset_bullets
                            302 	;;Obstacles
   50B8 CD B6 47      [17]  303 	call ob_init
                            304 	;;Other
   50BB 3E 10         [ 7]  305 	ld a, #0x10
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 66.
Hexadecimal [16-Bits]



   50BD 32 60 4F      [13]  306 	ld (contf1), a
   50C0 3E 10         [ 7]  307 	ld a, #0x10
   50C2 32 62 4F      [13]  308 	ld (contf2), a
   50C5 3E 10         [ 7]  309 	ld a, #0x10
   50C7 32 64 4F      [13]  310 	ld (contf3), a
                            311 	
   50CA CD 47 49      [17]  312 	call changeLocation
                            313 
   50CD C3 C8 4F      [10]  314 jp resetted
                            315 
   50D0                     316 reset_game_win:
                            317 
                            318 	;RESET THE GAME TO ITS DEFAULT VALUES
                            319 	;;Player
   50D0 CD A2 55      [17]  320 	call reset_player
                            321 	;;Enemies
   50D3 CD A1 4E      [17]  322 	call reset_enemies
                            323 	;;Bullets
   50D6 CD DF 45      [17]  324 	call reset_bullets
                            325 	;;Obstacles
   50D9 CD B6 47      [17]  326 	call ob_init
                            327 	;;Other
   50DC 3A 1A 52      [13]  328 	ld a, (level)
   50DF 3D            [ 4]  329 	dec a
   50E0 3D            [ 4]  330 	dec a
   50E1 20 13         [12]  331 	jr nz, not_level_2
                            332 
   50E3 3E 40         [ 7]  333 		ld a, #0x40
   50E5 32 60 4F      [13]  334 		ld (contf1), a
   50E8 32 61 4F      [13]  335 		ld (max_cont_f1), a
   50EB 3E 2A         [ 7]  336 		ld a, #0x2A
   50ED 32 62 4F      [13]  337 		ld (contf2), a
   50F0 32 63 4F      [13]  338 		ld (max_cont_f2), a
   50F3 C3 7E 51      [10]  339 		jp cont_changed
                            340 
   50F6                     341 	not_level_2:
                            342 
   50F6 3D            [ 4]  343 		dec a
   50F7 20 13         [12]  344 		jr nz, not_level_3
                            345 
   50F9 3E 3F         [ 7]  346 			ld a, #0x3F
   50FB 32 62 4F      [13]  347 			ld (contf2), a
   50FE 32 63 4F      [13]  348 			ld (max_cont_f2), a
   5101 3E 30         [ 7]  349 			ld a, #0x30
   5103 32 64 4F      [13]  350 			ld (contf3), a
   5106 32 65 4F      [13]  351 			ld (max_cont_f3), a
   5109 C3 7E 51      [10]  352 			jp cont_changed		
                            353 
   510C                     354 	not_level_3:
                            355 
   510C 3D            [ 4]  356 		dec a
   510D 20 1B         [12]  357 		jr nz, not_level_4
                            358 
   510F 3E 3E         [ 7]  359 			ld a, #0x3E
   5111 32 60 4F      [13]  360 			ld (contf1), a
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 67.
Hexadecimal [16-Bits]



   5114 32 61 4F      [13]  361 			ld (max_cont_f1), a
   5117 3E 30         [ 7]  362 			ld a, #0x30
   5119 32 62 4F      [13]  363 			ld (contf2), a
   511C 32 63 4F      [13]  364 			ld (max_cont_f2), a
   511F 3E 50         [ 7]  365 			ld a, #0x50
   5121 32 64 4F      [13]  366 			ld (contf3), a
   5124 32 65 4F      [13]  367 			ld (max_cont_f3), a
   5127 C3 7E 51      [10]  368 			jp cont_changed		
                            369 
   512A                     370 	not_level_4:
                            371 
   512A 3D            [ 4]  372 		dec a
   512B 20 1B         [12]  373 		jr nz, not_level_5
                            374 
   512D 3E 50         [ 7]  375 			ld a, #0x50
   512F 32 60 4F      [13]  376 			ld (contf1), a
   5132 32 61 4F      [13]  377 			ld (max_cont_f1), a
   5135 3E 35         [ 7]  378 			ld a, #0x35
   5137 32 62 4F      [13]  379 			ld (contf2), a
   513A 32 63 4F      [13]  380 			ld (max_cont_f2), a
   513D 3E 40         [ 7]  381 			ld a, #0x40
   513F 32 64 4F      [13]  382 			ld (contf3), a
   5142 32 65 4F      [13]  383 			ld (max_cont_f3), a
   5145 C3 7E 51      [10]  384 			jp cont_changed		
                            385 
   5148                     386 	not_level_5:
                            387 
   5148 3D            [ 4]  388 		dec a
   5149 20 1B         [12]  389 		jr nz, not_level_6
                            390 
   514B 3E 30         [ 7]  391 			ld a, #0x30
   514D 32 60 4F      [13]  392 			ld (contf1), a
   5150 32 61 4F      [13]  393 			ld (max_cont_f1), a
   5153 3E 40         [ 7]  394 			ld a, #0x40
   5155 32 62 4F      [13]  395 			ld (contf2), a
   5158 32 63 4F      [13]  396 			ld (max_cont_f2), a
   515B 3E 35         [ 7]  397 			ld a, #0x35
   515D 32 64 4F      [13]  398 			ld (contf3), a
   5160 32 65 4F      [13]  399 			ld (max_cont_f3), a
   5163 C3 7E 51      [10]  400 			jp cont_changed		
                            401 
   5166                     402 	not_level_6:
                            403 
   5166 3E 10         [ 7]  404 		ld a, #0x10
   5168 32 60 4F      [13]  405 		ld (contf1), a
   516B 32 61 4F      [13]  406 		ld (max_cont_f1), a
   516E 3E 10         [ 7]  407 		ld a, #0x10
   5170 32 62 4F      [13]  408 		ld (contf2), a
   5173 32 63 4F      [13]  409 		ld (max_cont_f2), a
   5176 3E 10         [ 7]  410 		ld a, #0x10
   5178 32 64 4F      [13]  411 		ld (contf3), a
   517B 32 65 4F      [13]  412 		ld (max_cont_f3), a
                            413 
   517E                     414 	cont_changed:
                            415 	
...
Hexadecimal [16-Bits]
   ...
   517E CD 47 49      [17]  416 	call changeLocation
                            417 
   5181 C3 DA 4F      [10]  418 jp resetted_win
                            419 
   5184                     420 checkShooted:
                            421 
   5184 3A A4 4A      [13]  422 	ld a, (shootEffect)
   5187 3D            [ 4]  423 	dec a
                            424 	;jp m, not_shooted
                            425 
   5188 F8            [11]  426 	ret m
                            427 
   5189 3E 01         [ 7]  428 	ld a, #1
   518B 6F            [ 4]  429 	ld l, a
   518C 3E 0F         [ 7]  430 	ld a, #15
   518E 67            [ 4]  431 	ld h, a
   518F 3E 3C         [ 7]  432 	ld a, #60
   5191 5F            [ 4]  433 	ld e, a
   5192 3E 00         [ 7]  434 	ld a, #0 
   5194 57            [ 4]  435 	ld d, a
   5195 01 00 00      [10]  436 	ld bc, #0x00
   5198 3E 01         [ 7]  437 	ld a, #1
   519A CD 84 5E      [17]  438 	call cpct_akp_SFXPlay_asm
                            439 
   519D 3E 00         [ 7]  440 	ld a, #00
   519F 32 A4 4A      [13]  441 	ld (shootEffect), a
                            442 
   51A2 C9            [10]  443 ret
                            444 
                            445 ;;A -> VIDEO POINTER;;;;
   51A3                     446 draw_Enemy_score:
                            447   	;;draw the enemy scoreboard sprite
   51A3 06 A0         [ 7]  448   	ld b, #0xA0 ;;Y
   51A5 0E 3F         [ 7]  449   	ld c, #0x3F         		
   51A7 57            [ 4]  450 	ld d, a
   51A8 1E 00         [ 7]  451 	ld e, #0
   51AA CD B5 61      [17]  452    	call cpct_getScreenPtr_asm
                            453 
   51AD EB            [ 4]  454    	ex de, hl
                            455 
   51AE 21 EC 0F      [10]  456    	ld hl, #_enemy_sc_sp
   51B1 06 16         [ 7]  457   	ld  b, #0x16
   51B3 0E 0B         [ 7]  458    	ld  c, #0x0B
   51B5 CD EF 5E      [17]  459    	call cpct_drawSprite_asm
   51B8 C9            [10]  460 ret
