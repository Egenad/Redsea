...
Hexadecimal [16-Bits]
                             ...
                             29 
                             30 
   5213 03                   31 lifes: .db #3
   5214 00                   32 no_lifes: .db #0
   5215 03                   33 enemies: .db #3
   5216 00                   34 cociente: .db #0
   5217 00                   35 resto: .db #0
   5218 03                   36 anim: .db #0x03
   5219 00                   37 sprHAct: .db #0x00
   521A 01                   38 level: 	.db 1
   521B 00                   39 state:  .db 0    		;;0 normal, 1 dying
   521C 0F                   40 animMuerto: .db #0x0F
                             41 
                     0006    42 max_level = 6
                             43 
                     ...
                     003D    51 pos_x_score2=#0x3D
                             52 
                             53 
   521D                      54 DefinePlayer hero_data, #0x24, #0x69, #0x00, #0x00, #0x08, #0x14, _hero_sp_0, pl_moveKeyboard
   521D                       1 hero_data: 
   000A                       2 	DefineDrawableEntity hero_data_drawable, #0x24, #0x69, #0x08, #0x14, _hero_sp_0
   000A                       1 hero_data_drawable:
   521D 24 69                 2 	.db #0x24, #0x69
   521F 08 14                 3 	.db #0x08, #0x14
   5221 FF 39                 4 	.dw _hero_sp_0
   5223 00 00                 3    .db   #0x00, #0x00     ;; VX, VY
   5225 56 52                 4    .dw   pl_moveKeyboard         ;; Update 
                     000A     5 hero_data_size = . - hero_data
   5227                      55 DefinePlayer shoot_data, #0x25, #0x40, #0x00, #0x00, #0x04, #0x8, _assets_sp_0, pl_moveAsShooter
   5227                       1 shoot_data: 
   0014                       2 	DefineDrawableEntity shoot_data_drawable, #0x25, #0x40, #0x04, #0x8, _assets_sp_0
   0014                       1 shoot_data_drawable:
   5227 25 40                 2 	.db #0x25, #0x40
   5229 04 08                 3 	.db #0x04, #0x8
   522B 07 36                 4 	.dw _assets_sp_0
   522D 00 00                 3    .db   #0x00, #0x00     ;; VX, VY
   522F 5B 53                 4    .dw   pl_moveAsShooter         ;; Update 
                     000A     5 shoot_data_size = . - shoot_data
                             56 
   5231                      57 pl_draw:
   5231 C3 BF 46      [10]   58 	jp render_draw
                             59 
   5234                      60 pl_update:
                             61 
   5234 DD 66 09      [19]   62 	ld     h, p_up_h(ix)
   5237 DD 6E 08      [19]   63    	ld     l, p_up_l(ix)
   523A E9            [ 4]   64    	jp    (hl)
                             65 
...
Hexadecimal [16-Bits]
   ...
   523B                      66 pl_clear:
   523B C3 F1 46      [10]   67 	jp render_clear
                             68 
   523E C9            [10]   69 	ret
                             70 
   523F                      71 pl_clear_mira:
                             72 
   523F C3 06 47      [10]   73 	jp render_clear_asset
                             74 
   5242 C9            [10]   75 	ret
                             76 
   5243                      77 pl_move:
                             78 
   5243 DD 7E 00      [19]   79    	ld    a, de_x(ix) 
   5246 DD 86 06      [19]   80    	add   p_vx(ix)
   5249 DD 77 00      [19]   81    	ld    de_x(ix), a
                             82 
   524C DD 7E 01      [19]   83    	ld    a, de_y(ix) 
   524F DD 86 07      [19]   84    	add   p_vy(ix)
   5252 DD 77 01      [19]   85    	ld    de_y(ix), a
                             86 
   5255 C9            [10]   87 	ret
                             88 
                             89 
   5256                      90 pl_moveKeyboard:
                             91 
   5256 3A 1B 52      [13]   92 	ld a, (state)
   5259 3D            [ 4]   93 	dec a
   525A CA 48 56      [10]   94 	jp z, esta_muriendo
                             95 
   525D CD D1 61      [17]   96 	call cpct_scanKeyboard_asm 		;; Scan keyboard
                             97 
   5260 21 04 04      [10]   98 	ld hl, #Key_O					;; Check key O
   5263 CD 9D 56      [17]   99 	call cpct_isKeyPressed_asm		;; If not pressed check P key
   5266 28 1F         [12]  100 	jr z, o_no_pulsada
   5268 21 05 80      [10]  101 	ld hl, #Key_Space				;; Check space key
   526B CD 9D 56      [17]  102 	call cpct_isKeyPressed_asm		;; If not pressed check P key
   526E 20 17         [12]  103 	jr nz, o_no_pulsada		
   5270 DD 7E 00      [19]  104 	ld a, de_x(ix)					;; Load player pos x 
   5273 3D            [ 4]  105 	dec a  							;; Dec pos x to check if its 0
   5274 FA D4 52      [10]  106 	jp m, no_te_muevas_again		;; If 0 stop moving player so dont be out of screen
   5277 DD 36 06 FF   [19]  107 	ld p_vx(ix), #-1 				;; If not 0, player velocity = -1 --> move left
                            108 	
                            109 	;;Change player sprite 
                            110 
   527B DD 7E 02      [19]  111 	ld a, de_w(ix)
   527E 47            [ 4]  112 	ld b, a 
   527F 3E 08         [ 7]  113 	ld a, #0x08
   5281 90            [ 4]  114 	sub b
   5282 20 03         [12]  115 	jr nz, no_update_sp
                            116 
                            117 	;;;;;;;;; Sprite Animation ;;;;;;;;;
                            118 
   5284 CD 1A 53      [17]  119 	call pl_AnimationSprite_I
                            120 
...
Hexadecimal [16-Bits]
   ...
   5287                     121 	no_update_sp:
                            122 
                            123 
   5287                     124 o_no_pulsada: 						;; Check P key
   5287 21 03 08      [10]  125 	ld hl, #Key_P 					
   528A CD 9D 56      [17]  126 	call cpct_isKeyPressed_asm 		;; If not press, dont do anything
   528D 28 27         [12]  127 	jr z, p_no_pulsada
   528F 21 05 80      [10]  128 	ld hl, #Key_Space 				;; Check space key
   5292 CD 9D 56      [17]  129 	call cpct_isKeyPressed_asm 		;; If not press, dont do anything
   5295 20 1F         [12]  130 	jr nz, p_no_pulsada			
                            131 	
   5297 DD 7E 00      [19]  132 	ld a, de_x(ix)					;; Load player pos x 
   529A D6 48         [ 7]  133 	sub #0x48 						;; Subtract max position
                            134 
   529C F2 D4 52      [10]  135 	jp p, no_te_muevas_again		;; If positive, dont move so dont be out the screen
                            136 
                            137 	;;Change player sprite
                            138 
   529F DD 7E 02      [19]  139 	ld a, de_w(ix)
   52A2 47            [ 4]  140 	ld b, a 
   52A3 3E 08         [ 7]  141 	ld a, #0x08
   52A5 90            [ 4]  142 	sub b
   52A6 20 03         [12]  143 	jr nz, no_update_sp_D
                            144 
                            145 
                            146 	;;;;;;;;;;; Sprite Animation ;;;;;;;;;;;
                            147 
   52A8 CD D9 52      [17]  148 	call pl_AnimationSprite_D
                            149 
   52AB                     150 	no_update_sp_D:
                            151 
   52AB                     152 loopeoagain:						;; Loop
   52AB 3D            [ 4]  153 	dec a 							;; a -1 
   52AC 05            [ 4]  154 	dec b           				;; b -1
   52AD 20 FC         [12]  155 	jr nz, loopeoagain 				;; If b = 0 -> end loop
   52AF 3D            [ 4]  156 	dec a 							;; a -1 again and check if is 0
   52B0 28 22         [12]  157 	jr z, no_te_muevas_again 		;; If is 0 --> player is max right position and dont move it
   52B2 DD 36 06 01   [19]  158 	ld p_vx(ix), #+1 				;; If not 0, change vel so move player to the right
                            159 
   52B6                     160 p_no_pulsada:
                            161 
   52B6 DD 7E 02      [19]  162 	ld a, de_w(ix)
   52B9 47            [ 4]  163 	ld b, a 
   52BA 3E 08         [ 7]  164 	ld a, #0x08
   52BC 90            [ 4]  165 	sub b
   52BD 20 12         [12]  166 	jr nz, no_update_sp_C
                            167 
   52BF DD 7E 06      [19]  168 	ld a, p_vx(ix)
   52C2 47            [ 4]  169 	ld b, a 
   52C3 3E 00         [ 7]  170 	ld a, #0x0
   52C5 90            [ 4]  171 	sub b 
   52C6 20 09         [12]  172 	jr nz, no_update_sp_C
                            173 
   52C8 21 FF 39      [10]  174 	ld hl, #_hero_sp_0
   52CB DD 74 05      [19]  175 	ld de_sp_h(ix), h
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



   52CE DD 75 04      [19]  176 	ld de_sp_l(ix), l
                            177 
   52D1                     178 	no_update_sp_C:
                            179 
   52D1 CD 43 52      [17]  180 	call pl_move 					;; Call move method
   52D4                     181 	no_te_muevas_again: 			;; Tag to jump when player is on the edges
   52D4 DD 36 06 00   [19]  182 	ld p_vx(ix), #0x00 				;; Change vel = 0, stop moving player
   52D8                     183 no_updatear:
                            184 
   52D8 C9            [10]  185 	ret
                            186 
                            187 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            190 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            191 
   52D9                     192 pl_AnimationSprite_D:
                            193 
   52D9 3A 18 52      [13]  194 	ld a, (anim)
   52DC 3D            [ 4]  195 	dec a
   52DD 20 33         [12]  196 	jr nz, dont_try
                            197 
   52DF 3E 03         [ 7]  198 	ld a, #0x03
   52E1 32 18 52      [13]  199 	ld (anim), a
                            200 
   52E4 3A 19 52      [13]  201 	ld a, (sprHAct)
   52E7 47            [ 4]  202 	ld b, a 
                            203 
   52E8 21 BF 3D      [10]  204 	ld hl, #_hero_sp_6
   52EB 3E 01         [ 7]  205 	ld a, #0x01 
   52ED 32 19 52      [13]  206 	ld (sprHAct), a
   52F0 05            [ 4]  207 	dec b
   52F1 FA 0C 53      [10]  208 	jp m, dont_continue
   52F4 21 9F 3A      [10]  209 	ld hl, #_hero_sp_1
   52F7 3E 02         [ 7]  210 	ld a, #0x02
   52F9 32 19 52      [13]  211 	ld (sprHAct), a
   52FC 05            [ 4]  212 	dec b
   52FD FA 0C 53      [10]  213 	jp m, dont_continue
   5300 21 3F 3B      [10]  214 	ld hl, #_hero_sp_2
   5303 3E 00         [ 7]  215 	ld a, #0x00
   5305 32 19 52      [13]  216 	ld (sprHAct), a
   5308 05            [ 4]  217 	dec b
   5309 FA 0C 53      [10]  218 	jp m, dont_continue
                            219 
   530C                     220 	dont_continue:
                            221 
   530C DD 74 05      [19]  222 	ld de_sp_h(ix), h
   530F DD 75 04      [19]  223 	ld de_sp_l(ix), l
                            224 
   5312                     225 	dont_try:
   5312 3A 18 52      [13]  226 	ld a, (anim)
   5315 3D            [ 4]  227 	dec a
   5316 32 18 52      [13]  228 	ld (anim), a
   5319 C9            [10]  229 	ret
                            230 
...
Hexadecimal [16-Bits]
                            ...
                            235 
                            236 
   531A                     237 pl_AnimationSprite_I:
   531A 3A 18 52      [13]  238 	ld a, (anim)
   531D 3D            [ 4]  239 	dec a
   531E 20 33         [12]  240 	jr nz, dont_try_I
                            241 
   5320 3E 03         [ 7]  242 	ld a, #0x03
   5322 32 18 52      [13]  243 	ld (anim), a
                            244 
   5325 3A 19 52      [13]  245 	ld a, (sprHAct)
   5328 47            [ 4]  246 	ld b, a 
                            247 
   5329 21 1F 3D      [10]  248 	ld hl, #_hero_sp_5
   532C 3E 01         [ 7]  249 	ld a, #0x01 
   532E 32 19 52      [13]  250 	ld (sprHAct), a
   5331 05            [ 4]  251 	dec b
   5332 FA 4D 53      [10]  252 	jp m, dont_continue_I
   5335 21 7F 3C      [10]  253 	ld hl, #_hero_sp_4
   5338 3E 02         [ 7]  254 	ld a, #0x02
   533A 32 19 52      [13]  255 	ld (sprHAct), a
   533D 05            [ 4]  256 	dec b
   533E FA 4D 53      [10]  257 	jp m, dont_continue_I
   5341 21 DF 3B      [10]  258 	ld hl, #_hero_sp_3
   5344 3E 00         [ 7]  259 	ld a, #0x00
   5346 32 19 52      [13]  260 	ld (sprHAct), a
   5349 05            [ 4]  261 	dec b
   534A FA 4D 53      [10]  262 	jp m, dont_continue_I
                            263 
   534D                     264 	dont_continue_I:
                            265 
   534D DD 74 05      [19]  266 	ld de_sp_h(ix), h
   5350 DD 75 04      [19]  267 	ld de_sp_l(ix), l
                            268 
   5353                     269 	dont_try_I:
   5353 3A 18 52      [13]  270 	ld a, (anim)
   5356 3D            [ 4]  271 	dec a
   5357 32 18 52      [13]  272 	ld (anim), a
                            273 
   535A C9            [10]  274 	ret
                            275 
                            276 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            279 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            280 
   535B                     281 pl_moveAsShooter:
                            282 
   535B CD D1 61      [17]  283 	call cpct_scanKeyboard_asm 		;; Scan keyboard
                            284 
   535E 21 08 08      [10]  285 	ld hl, #Key_Q 					;; Check if Q key is pressed
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 66.
Hexadecimal [16-Bits]



   5361 CD 9D 56      [17]  286 	call cpct_isKeyPressed_asm 		
   5364 28 0F         [12]  287 	jr z, q_no_pulsada 				;; If not pressed, check A key
   5366 DD 7E 01      [19]  288 		ld a, de_y(ix) 					;;Load gun pos Y
   5369 06 1E         [ 7]  289 		ld b, #30 						;; Check if its inside the game screen
   536B 90            [ 4]  290 		sub b
   536C 28 54         [12]  291 		jr z, no_te_muevas
   536E FA C2 53      [10]  292 		jp m, no_te_muevas
   5371 DD 36 07 FE   [19]  293 		ld p_vy(ix), #-2 				;; If its inside, change vel to -2, move up
   5375                     294 q_no_pulsada:
   5375 21 08 20      [10]  295 	ld hl, #Key_A 					;; Check A key
   5378 CD 9D 56      [17]  296 	call cpct_isKeyPressed_asm  	
   537B 28 0C         [12]  297 	jr z, a_no_pulsada 				;;If not pressed, check Spce key
   537D DD 7E 01      [19]  298 		ld a, de_y(ix) 					;;Load gun pos Y
   5380 D6 70         [ 7]  299 		sub #0x70 						;; Check if its inside the game screen
   5382 F2 C2 53      [10]  300 		jp p, no_te_muevas 				;; Si da 0 significa que estamos en el borde de abajo de pantalla y no muevo la mira
   5385 DD 36 07 02   [19]  301 		ld p_vy(ix), #+2 				;; If its inside, change vel to -2, move down
   5389                     302 a_no_pulsada:
                            303 	
   5389 21 05 80      [10]  304 	ld hl, #Key_Space				;; Check space key
   538C CD 9D 56      [17]  305 	call cpct_isKeyPressed_asm		
   538F 28 2E         [12]  306 	jr z, Space_no_pulsado 			
                            307 		;; if its pressed, check O or P
                            308 
   5391 CD 39 55      [17]  309 		call pl_shoot 	;;Shoot
                            310 
                            311 		;;Move right or Left
                            312 
   5394 21 04 04      [10]  313 		ld hl, #Key_O					;; Check O key
   5397 CD 9D 56      [17]  314 		call cpct_isKeyPressed_asm		;; If not pressed, check P key
   539A 28 0B         [12]  315 		jr z, o2_no_pulsada		
   539C DD 7E 00      [19]  316 		ld a, de_x(ix)					;; Load gun pos x
   539F 3D            [ 4]  317 		dec a  							;; Dec pos x
   53A0 FA C2 53      [10]  318 		jp m, no_te_muevas 				;; If its negative, it would be out screen so dont move
   53A3 DD 36 06 FF   [19]  319 		ld p_vx(ix), #-1
                            320 
   53A7                     321 		o2_no_pulsada:
                            322 
   53A7 21 03 08      [10]  323 		ld hl, #Key_P 					;; Check P key
   53AA CD 9D 56      [17]  324 		call cpct_isKeyPressed_asm 		;; If not pressed, dont do anything
   53AD 28 10         [12]  325 		jr z, Space_no_pulsado			
   53AF DD 7E 00      [19]  326 		ld a, de_x(ix)					;; Load gun pos x
   53B2 06 4D         [ 7]  327 		ld b, #0x4D
   53B4                     328 		loopeoagain2:						;; Loop
   53B4 3D            [ 4]  329 			dec a 							;; a -1 
   53B5 05            [ 4]  330 			dec b           				;; b -1
   53B6 20 FC         [12]  331 			jr nz, loopeoagain2 				;; if b = cero, end loop
   53B8 3D            [ 4]  332 			dec a 							;; a-1 
   53B9 28 07         [12]  333 		jr z, no_te_muevas 			 	;; if a = 0 -> dont move because is on the max right
   53BB DD 36 06 01   [19]  334 		ld p_vx(ix), #+1 
                            335 
   53BF                     336 Space_no_pulsado:
   53BF CD 43 52      [17]  337 	call pl_move 					;; Call move method
   53C2                     338 no_te_muevas:
   53C2 DD 36 07 00   [19]  339 	ld p_vy(ix), #0 				;; Reset velocity y = 0
   53C6 DD 36 06 00   [19]  340 	ld p_vx(ix), #0 				;; Reset velocity x = 0
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 67.
Hexadecimal [16-Bits]



   53CA CD 56 52      [17]  341 	call pl_moveKeyboard 			;; Check player movement
                            342 
   53CD C9            [10]  343 	ret
                            344 
                            345 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   53CE                     352 get_Enemy:
                            353 
   53CE 3A 15 52      [13]  354 	ld a, (enemies)
   53D1 3D            [ 4]  355 	dec a
   53D2 20 1D         [12]  356 	jr nz, not_finished 		;; If not 0, player didnt kill all enemies
   53D4 28 03         [12]  357 	jr z, finished
   53D6 FA D9 53      [10]  358 	jp m, finished
                            359 
   53D9                     360 	finished:
   53D9 47            [ 4]  361 	ld b, a
   53DA 3A 1A 52      [13]  362 	ld a, (level)
   53DD D6 06         [ 7]  363 	sub #6 
   53DF 20 0A         [12]  364 	jr nz, no_final_win
                            365 
   53E1 CD F6 45      [17]  366 	call init_win
   53E4 78            [ 4]  367 	ld a, b
   53E5 32 15 52      [13]  368 	ld (enemies), a
   53E8 C3 C0 55      [10]  369 	jp pl_next_level
                            370 
   53EB                     371 no_final_win:
                            372 
   53EB CD BA 51      [17]  373 	call init_nextLevel
   53EE CD C0 55      [17]  374 	call pl_next_level 			;; Win level -> Reset game
                            375 
   53F1                     376 	not_finished:
   53F1 32 15 52      [13]  377 	ld (enemies), a 			;; Update enemies to kill
                            378 	;call draw_Score
   53F4 C9            [10]  379 ret
                            380 
                            381 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   53F5                     387 draw_Score:
                            ...
                            390 
   53F5 3A 15 52      [13]  391 	ld a, (enemies) 				;; Enemies number in total
   53F8 6F            [ 4]  392 	ld l, a
   53F9 3E 00         [ 7]  393 	ld a, #0
   53FB 67            [ 4]  394 	ld h, a 						;; Divide: HL
   53FC 3E 0A         [ 7]  395 	ld a, #10
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 68.
Hexadecimal [16-Bits]



   53FE 5F            [ 4]  396 	ld e, a
   53FF 01 00 00      [10]  397   	ld bc,#0                     	;; BC is used to accumulate the result (Osea que aqui voy a tener el Cociente de la division)
   5402 16 00         [ 7]  398   	ld d, #0                    	;; clearing D, so DE holds the divisor --> Ahora mismo tendria en de 0x000A (10 en decimal)
   5404                     399 	DivLoop:
   5404 7D            [ 4]  400 		ld a, l  		            ;; subtracting DE from HL until the first overflow
   5405 32 17 52      [13]  401 		ld (resto), a
   5408 ED 52         [15]  402   		sbc hl,de
   540A FA 0E 54      [10]  403   		jp m, no_increment                  	;; since the carry is zero, SBC works as if it was a SUB
   540D 03            [ 6]  404   		inc bc
   540E                     405   	no_increment:                      ;; note that this instruction does not alter the flags
   540E 30 F4         [12]  406   	jr nc, DivLoop                  ;; no carry means that there was no overflow --> Si no hay carry es que aun puedo dividir
                            407 
                            408 
                            ...
                            412 
   5410 79            [ 4]  413   	ld a, c
   5411 32 16 52      [13]  414   	ld (cociente), a
                            415 
   5414 3A A3 46      [13]  416 	ld     a, (m_back_buffer)
   5417 57            [ 4]  417 	ld     d, a
   5418 1E 00         [ 7]  418 	ld     e, #0
   541A 0E 3A         [ 7]  419 	ld     c, #pos_x_score1         		;; C = Title X
   541C 06 A8         [ 7]  420    	ld     b, #pos_y_score1         		;; B = Title Y
   541E CD B5 61      [17]  421    	call cpct_getScreenPtr_asm
                            422 
                            423    	
   5421 EB            [ 4]  424    	ex    de, hl   					;; DE = memory pointer
                            425 
                            426 
   5422 3A 16 52      [13]  427    	ld a, (cociente)
                            428    	
   5425 CD 4B 54      [17]  429    	call calculate_Number
                            430 
   5428 06 07         [ 7]  431    	ld  b, #0x07 	;;height
   542A 0E 03         [ 7]  432    	ld  c, #0x03 	;;width
                            433 
   542C CD EF 5E      [17]  434    	call cpct_drawSprite_asm
                            435 
   542F 3A A3 46      [13]  436    	ld     a, (m_back_buffer)
   5432 57            [ 4]  437 	ld     d, a
   5433 1E 00         [ 7]  438 	ld     e, #0
   5435 0E 3D         [ 7]  439 	ld     c, #pos_x_score2         		;; C = Title X
   5437 06 A8         [ 7]  440    	ld     b, #pos_y_score1         		;; B = Title Y
   5439 CD B5 61      [17]  441    	call cpct_getScreenPtr_asm
                            442 
                            443    	
   543C EB            [ 4]  444    	ex    de, hl   					;; DE = memory pointer
   543D 3A 17 52      [13]  445 	ld a, (resto)
                            446    	
   5440 CD 4B 54      [17]  447    	call calculate_Number
                            448 
   5443 06 07         [ 7]  449    	ld  b, #0x07 	;;height
   5445 0E 03         [ 7]  450    	ld  c, #0x03 	;;width
...
Hexadecimal [16-Bits]
                            ...
                            451 
   5447 CD EF 5E      [17]  452    	call cpct_drawSprite_asm	
                            453 
   544A C9            [10]  454 ret
                            455 
                            456 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            461 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            462 
   544B                     463 calculate_Number:
                            464 
   544B 3D            [ 4]  465 	dec a
   544C FA 73 54      [10]  466    	jp m, n_cero
   544F 3D            [ 4]  467    	dec a
   5450 FA 79 54      [10]  468    	jp m, n_uno
   5453 3D            [ 4]  469    	dec a
   5454 FA 7F 54      [10]  470    	jp m, n_dos
   5457 3D            [ 4]  471    	dec a
   5458 FA 85 54      [10]  472    	jp m, n_tres
   545B 3D            [ 4]  473    	dec a
   545C FA 8B 54      [10]  474    	jp m, n_cuatro
   545F 3D            [ 4]  475    	dec a
   5460 FA 91 54      [10]  476    	jp m, n_cinco
   5463 3D            [ 4]  477    	dec a
   5464 FA 97 54      [10]  478    	jp m, n_seis
   5467 3D            [ 4]  479    	dec a
   5468 FA 9D 54      [10]  480    	jp m, n_siete
   546B 3D            [ 4]  481    	dec a
   546C FA A3 54      [10]  482    	jp m, n_ocho
   546F 3D            [ 4]  483    	dec a
   5470 FA A9 54      [10]  484    	jp m, n_nueve
                            485 
   5473                     486    	n_cero:
   5473 21 35 26      [10]  487 	ld hl, #_numbers_00
   5476 C3 AC 54      [10]  488 	jp load_number
   5479                     489 	n_uno:
   5479 21 4A 26      [10]  490 	ld hl, #_numbers_01
   547C C3 AC 54      [10]  491 	jp load_number
   547F                     492 	n_dos:
   547F 21 5F 26      [10]  493 	ld hl, #_numbers_02
   5482 C3 AC 54      [10]  494 	jp load_number
   5485                     495 	n_tres:
   5485 21 74 26      [10]  496 	ld hl, #_numbers_03
   5488 C3 AC 54      [10]  497 	jp load_number
   548B                     498 	n_cuatro:
   548B 21 89 26      [10]  499 	ld hl, #_numbers_04
   548E C3 AC 54      [10]  500 	jp load_number
   5491                     501 	n_cinco:
   5491 21 9E 26      [10]  502 	ld hl, #_numbers_05
   5494 C3 AC 54      [10]  503 	jp load_number
   5497                     504 	n_seis:
   5497 21 B3 26      [10]  505 	ld hl, #_numbers_06
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 70.
Hexadecimal [16-Bits]



   549A C3 AC 54      [10]  506 	jp load_number
   549D                     507 	n_siete:
   549D 21 C8 26      [10]  508 	ld hl, #_numbers_07
   54A0 C3 AC 54      [10]  509 	jp load_number
   54A3                     510 	n_ocho:
   54A3 21 DD 26      [10]  511 	ld hl, #_numbers_08
   54A6 C3 AC 54      [10]  512 	jp load_number
   54A9                     513 	n_nueve:
   54A9 21 F2 26      [10]  514 	ld hl, #_numbers_09
                            515 
   54AC                     516 	load_number:
                            517 
   54AC C9            [10]  518 ret
                            519 
                            520 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   54AD                     526 draw_Lifes:
                            527 
   54AD 3A 13 52      [13]  528 	ld a, (lifes) 		;; Current player lifes
   54B0 47            [ 4]  529 	ld b, a
   54B1 3E 03         [ 7]  530 	ld a, #3 			;; Max player lifes
   54B3 90            [ 4]  531 	sub b  				;; Substrac current lifes to max lifes
   54B4 32 14 52      [13]  532 	ld (no_lifes), a 	 			
                            533 
                            ...
                            536 
   54B7 3D            [ 4]  537 	dec a
   54B8 FA C8 54      [10]  538 	jp m, tercero_positivo
                            539 
                            540 
   54BB 32 14 52      [13]  541 	ld (no_lifes), a
                            542 	;; Negative
                            543 
                            544 	
   54BE 0E 21         [ 7]  545 	ld     c, #pos_x_life2        		;; C = Title X
   54C0 06 90         [ 7]  546    	ld     b, #pos_y_life      		;; B = Title Y
   54C2 CD 24 55      [17]  547    	call draw_Life_Sprite_1
                            548 
   54C5 C3 D2 54      [10]  549    	jp comprobacion_next
                            550 
                            551 	;; Positive
   54C8                     552 	tercero_positivo:
                            553 
   54C8 32 14 52      [13]  554 	ld (no_lifes), a
                            555 
                            556 	
   54CB 0E 21         [ 7]  557 	ld     c, #pos_x_life2       		;; C = Title X
   54CD 06 90         [ 7]  558    	ld     b, #pos_y_life        		;; B = Title Y
   54CF CD 0F 55      [17]  559    	call draw_Life_Sprite_0
                            560 
...
Hexadecimal [16-Bits]
   ...
   54D2                     561    	comprobacion_next:
                            562 
   54D2 3A 14 52      [13]  563    	ld a, (no_lifes)
                            564 
   54D5 3D            [ 4]  565    	dec a 
   54D6 FA E6 54      [10]  566    	jp m, segundo_positivo
                            567 
                            568 
   54D9 32 14 52      [13]  569 	ld (no_lifes), a
                            570 	;; Negative
                            571 
                            572 	
   54DC 0E 15         [ 7]  573 	ld     c, #pos_x_life1         		;; C = Title X
   54DE 06 90         [ 7]  574    	ld     b, #pos_y_life        		;; B = Title Y
   54E0 CD 24 55      [17]  575    	call draw_Life_Sprite_1
                            576 
   54E3 C3 F0 54      [10]  577    	jp comprobacion_next2
                            578 
                            579 	;; Positive
   54E6                     580 	segundo_positivo:
                            581 
   54E6 32 14 52      [13]  582 	ld (no_lifes), a
                            583 
                            584 	
   54E9 0E 15         [ 7]  585 	ld     c, #pos_x_life1         		;; C = Title X
   54EB 06 90         [ 7]  586    	ld     b, #pos_y_life         		;; B = Title Y
   54ED CD 0F 55      [17]  587    	call draw_Life_Sprite_0
                            588 
   54F0                     589    	comprobacion_next2:
                            590 
   54F0 3A 14 52      [13]  591    	ld a, (no_lifes)
                            592 
   54F3 3D            [ 4]  593    	dec a 
   54F4 FA 04 55      [10]  594    	jp m, primero_positivo
                            595 
                            596 
   54F7 32 14 52      [13]  597 	ld (no_lifes), a
                            598 	;; Negative
                            599 
                            600 	
   54FA 0E 09         [ 7]  601 	ld     c, #pos_x_life3         		;; C = Title X
   54FC 06 90         [ 7]  602    	ld     b, #pos_y_life         		;; B = Title Y
   54FE CD 24 55      [17]  603    	call draw_Life_Sprite_1
                            604 
   5501 C3 0E 55      [10]  605    	jp comprobacion_next3
                            606 
                            607 	;; Positive
   5504                     608 	primero_positivo:
                            609 
   5504 32 14 52      [13]  610 	ld (no_lifes), a
                            611 
   5507 0E 09         [ 7]  612 	ld     c, #pos_x_life3        		;; C = Title X
   5509 06 90         [ 7]  613    	ld     b, #pos_y_life        		;; B = Title Y
   550B CD 0F 55      [17]  614 	call draw_Life_Sprite_0
                            615 
...
Hexadecimal [16-Bits]
   ...
   550E                     616    	comprobacion_next3:
                            617 
   550E C9            [10]  618 ret
                            619 
   550F                     620 draw_Life_Sprite_0:
                            621 
   550F 3A A3 46      [13]  622 	ld     a, (m_back_buffer)
   5512 57            [ 4]  623 	ld     d, a
   5513 1E 00         [ 7]  624 	ld     e, #0
   5515 CD B5 61      [17]  625    	call cpct_getScreenPtr_asm
                            626 
   5518 EB            [ 4]  627    	ex    de, hl   					;; DE = memory pointer
                            628 
   5519 21 C9 1B      [10]  629 	ld hl, #_lifes_0
   551C 06 16         [ 7]  630 	ld  b, #0x16 	;;height
   551E 0E 0B         [ 7]  631    	ld  c, #0x0B 	;;width
                            632 
   5520 CD EF 5E      [17]  633    	call cpct_drawSprite_asm
                            634 
   5523 C9            [10]  635 ret
                            636 
   5524                     637 draw_Life_Sprite_1:
                            638 
   5524 3A A3 46      [13]  639 	ld     a, (m_back_buffer)
   5527 57            [ 4]  640 	ld     d, a
   5528 1E 00         [ 7]  641 	ld     e, #0
   552A CD B5 61      [17]  642    	call cpct_getScreenPtr_asm
                            643 
   552D EB            [ 4]  644    	ex    de, hl   					;; DE = memory pointer
                            645 
   552E 21 BB 1C      [10]  646 	ld hl, #_lifes_1
   5531 06 16         [ 7]  647 	ld  b, #0x16 	;;height
   5533 0E 0B         [ 7]  648    	ld  c, #0x0B 	;;width
                            649 
   5535 CD EF 5E      [17]  650    	call cpct_drawSprite_asm
                            651 
   5538 C9            [10]  652 ret
                            653 
   5539                     654 pl_shoot:
   5539 21 98 47      [10]  655 	ld hl, #obstacle
   553C CD 46 55      [17]  656 	call pl_checkCollisionObstacle
   553F 21 9F 47      [10]  657 	ld hl, #obstacle2
   5542 CD 46 55      [17]  658 	call pl_checkCollisionObstacle
                            659 
   5545 C9            [10]  660 ret
                            661 
   5546                     662 pl_checkCollisionObstacle:
                            663 
                            664 	;;check collision gun - obstacle
   5546 DD 7E 00      [19]  665 	ld a, de_x(ix) 		  ;;a=gun_x
   5549 DD 46 02      [19]  666 	ld b, de_w(ix)		  ;;b=gun_w
   554C 80            [ 4]  667 	add b         		  ;;a=gun_x+gun_w
   554D 46            [ 7]  668 	ld b, (hl)     		  ;;b=obstacle_x
   554E 90            [ 4]  669 	sub b 				  ;;a=(gun_x+gun_w)-obstacle_x
   554F 28 33         [12]  670 	jr z, no_collisionO
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 73.
Hexadecimal [16-Bits]



   5551 FA 84 55      [10]  671 	jp m, no_collisionO
                            672 
                            673 	;;check collision obstacle - gun
   5554 7E            [ 7]  674 	ld a, (hl) 		  	  ;;a=obstacle_x
   5555 23            [ 6]  675 	inc hl
   5556 23            [ 6]  676 	inc hl
   5557 46            [ 7]  677 	ld b, (hl)			  ;;b=obstacle_w
   5558 80            [ 4]  678 	add b         		  ;;a=obstacle_x+obstacle_w
   5559 DD 46 00      [19]  679 	ld b, de_x(ix)   	  ;;b=gun_x
   555C 90            [ 4]  680 	sub b 				  ;;a=(obstacle_x+obstacle_w)-gun_x
   555D 28 25         [12]  681 	jr z, no_collisionO 	  
   555F FA 84 55      [10]  682 	jp m, no_collisionO
                            683 
                            684 	;;check collision  obstacle
                            685 	;;  -
                            686 	;; gun
                            687 
   5562 2B            [ 6]  688 	dec hl				  ;;hl --> obstacle_y
   5563 7E            [ 7]  689 	ld a, (hl)            ;;a=obstacle_y
   5564 23            [ 6]  690 	inc hl
   5565 23            [ 6]  691 	inc hl				  ;;hl --> obstacle_h
   5566 46            [ 7]  692 	ld b, (hl) 		  	  ;;a=obstacle_h
   5567 80            [ 4]  693 	add b         		  ;;a=obstacle_y+obstacle_h
   5568 DD 46 01      [19]  694 	ld b, de_y(ix)   	  ;;b=gun_y
   556B 90            [ 4]  695 	sub b 				  ;;a=(obstacle_y+obstacle_h)-gun_y
   556C 28 16         [12]  696 	jr z, no_collisionO 	  
   556E FA 84 55      [10]  697 	jp m, no_collisionO
                            698 
                            699 	;;check collision  enemy
                            700 						  ;;  -
                            701 						  ;; shoot
                            702 
   5571 DD 7E 01      [19]  703 	ld a, de_y(ix)        ;;a=gun_y
   5574 DD 46 03      [19]  704 	ld b, de_h(ix)	  	  ;;a=gun_h
   5577 80            [ 4]  705 	add b         		  ;;a=gun_y+gun_h
   5578 2B            [ 6]  706 	dec hl
   5579 2B            [ 6]  707 	dec hl 				  ;;hl --> obstacle_y
   557A 46            [ 7]  708 	ld b, (hl)			  ;;b=obstacle_y
   557B 90            [ 4]  709 	sub b 				  ;;a=(obstacle_y+obstacle_h)-gun_y
   557C 28 06         [12]  710 	jr z, no_collisionO 	  
   557E FA 84 55      [10]  711 	jp m, no_collisionO
                            712 
   5581 CD D0 47      [17]  713 	call ob_damage
                            714 
   5584                     715 no_collisionO:
                            716 
   5584 C9            [10]  717 	ret
                            718 
                            719 
...
Hexadecimal [16-Bits]
   ...
   5585 3A 13 52      [13]  726 	ld a, (lifes)
   5588 3D            [ 4]  727 	dec a 
   5589 FA 2F 56      [10]  728 	jp m, game_over
   558C 32 13 52      [13]  729 	ld (lifes), a
                            730 
   558F 3E 01         [ 7]  731 	ld a, #1
   5591 32 1B 52      [13]  732 	ld (state), a
                            733 
   5594 01 FF 3E      [10]  734 	ld bc, #_hero_sp_8
   5597 21 1D 52      [10]  735 	ld hl, #hero_data
   559A 23            [ 6]  736 	inc hl
   559B 23            [ 6]  737 	inc hl
   559C 23            [ 6]  738 	inc hl
   559D 23            [ 6]  739 	inc hl
   559E 71            [ 7]  740 	ld (hl), c
   559F 23            [ 6]  741 	inc hl
   55A0 70            [ 7]  742 	ld (hl), b
                            743 
   55A1 C9            [10]  744 	ret
                            745 
                            746 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            748 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            749 
   55A2                     750 reset_player:
                            751 
                            752 	;;hero_data
   55A2 DD 21 1D 52   [14]  753 	ld ix, #hero_data
   55A6 DD 36 00 24   [19]  754 	ld de_x(ix), #0x24
   55AA DD 36 01 69   [19]  755 	ld de_y(ix), #0x69
                            756 	;;shoot_data
   55AE DD 21 27 52   [14]  757 	ld ix, #shoot_data
   55B2 DD 36 00 25   [19]  758 	ld de_x(ix), #0x25
   55B6 DD 36 01 30   [19]  759 	ld de_y(ix), #0x30
                            760 	;;animation time
   55BA 3E 02         [ 7]  761 	ld a, #0x02
   55BC 32 18 52      [13]  762 	ld (anim), a
                            763 
   55BF C9            [10]  764 	ret
                            765 
                            766 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            769 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            770 
   55C0                     771 pl_next_level:
                            772 	
                            773 
   55C0 3A 1A 52      [13]  774 	ld a, (level)
   55C3 3C            [ 4]  775 	inc a
   55C4 32 1A 52      [13]  776 	ld (level), a
                            777 	
   55C7 3D            [ 4]  778 	dec a
   55C8 3D            [ 4]  779 	dec a
   55C9 20 0B         [12]  780 	jr nz, no_level_2
...
Hexadecimal [16-Bits]
                            ...
                            781 
   55CB 3E 05         [ 7]  782 		ld a, #5
   55CD 32 15 52      [13]  783 		ld (enemies), a
                            784 
   55D0 CD 06 4F      [17]  785 		call ent_start_level_2
   55D3 C3 D0 50      [10]  786 		jp reset_game_win
                            787 
   55D6                     788 	no_level_2:
                            789 
   55D6 3D            [ 4]  790 		dec a
   55D7 20 0E         [12]  791 		jr nz, no_level_3
                            792 
   55D9 3E 08         [ 7]  793 			ld a, #8
   55DB 32 15 52      [13]  794 			ld (enemies), a
                            795 			
   55DE CD 27 48      [17]  796 			call ob_level_3
   55E1 CD 1B 4F      [17]  797 			call ent_start_level_3
   55E4 C3 D0 50      [10]  798 			jp reset_game_win
                            799 
   55E7                     800 	no_level_3:
                            801 
   55E7 3D            [ 4]  802 		dec a
   55E8 20 0E         [12]  803 		jr nz, no_level_4
                            804 
   55EA 3E 0A         [ 7]  805 			ld a, #10
   55EC 32 15 52      [13]  806 			ld (enemies), a
                            807 
   55EF CD 45 48      [17]  808 			call ob_level_4
   55F2 CD 2B 4F      [17]  809 			call ent_start_level_4
   55F5 C3 D0 50      [10]  810 			jp reset_game_win
                            811 
   55F8                     812 	no_level_4:
                            813 
   55F8 3D            [ 4]  814 		dec a
   55F9 20 0E         [12]  815 		jr nz, no_level_5
                            816 
   55FB 3E 0F         [ 7]  817 			ld a, #15
   55FD 32 15 52      [13]  818 			ld (enemies), a
                            819 
   5600 CD 63 48      [17]  820 			call ob_level_5
   5603 CD 3B 4F      [17]  821 			call ent_start_level_5
   5606 C3 D0 50      [10]  822 			jp reset_game_win
                            823 
   5609                     824 	no_level_5:
                            825 
   5609 3D            [ 4]  826 		dec a
   560A 20 0E         [12]  827 		jr nz, no_level_6
                            828 
   560C 3E 14         [ 7]  829 			ld a, #20
   560E 32 15 52      [13]  830 			ld (enemies), a
                            831 
   5611 CD 81 48      [17]  832 			call ob_level_6
   5614 CD 50 4F      [17]  833 			call ent_start_level_6
   5617 C3 D0 50      [10]  834 			jp reset_game_win
                            835 
...
Hexadecimal [16-Bits]
   ...
   561A                     836 	no_level_6:
                            837 
   561A 3E 03         [ 7]  838 		ld a, #3
   561C 32 15 52      [13]  839 		ld (enemies), a
                            840 
   561F CD 09 48      [17]  841 		call ob_level_1
                            842 		;call ent_start_level_1
                            843 		;;lifes
   5622 3E 03         [ 7]  844 		ld a, #0x03
   5624 32 13 52      [13]  845 		ld (lifes), a
   5627 3E 01         [ 7]  846 		ld a, #1
   5629 32 1A 52      [13]  847 		ld (level), a
                            848 
   562C C3 AF 50      [10]  849 		jp reset_game
                            850 
                            851 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            852 ;;;;;;;;;;;GAME_OVER;;;;;;;;;;;;;;
                            853 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   562F                     855 game_over:
                            856 	
   562F 3E 01         [ 7]  857 	ld a, #1
   5631 32 1A 52      [13]  858 	ld (level), a
                            859 
   5634 3E 03         [ 7]  860 	ld a, #3
   5636 32 15 52      [13]  861 	ld (enemies), a
                            862 
                            863 	;;lifes
   5639 3E 03         [ 7]  864 	ld a, #0x03
   563B 32 13 52      [13]  865 	ld (lifes), a
                            866 
   563E CD 42 47      [17]  867 	call init_gameOver	
   5641 CD 09 48      [17]  868 	call ob_level_1
   5644 CD AF 50      [17]  869 	call reset_game 			
                            870 
   5647 C9            [10]  871 	ret
                            872 
                            873 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            874 ;;;;;;;;;;;ESTA_MURIENDO;;;;;;;;;;
                            875 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   5648                     876 esta_muriendo:
                            877 
   5648 3A 1C 52      [13]  878 	ld a, (animMuerto)
   564B 3D            [ 4]  879 	dec a
   564C 20 0D         [12]  880 	jr nz, no_reviv
   564E 3E 00         [ 7]  881 	ld a, #0
   5650 32 1B 52      [13]  882 	ld (state), a ;;revive
   5653 3E 0F         [ 7]  883 	ld a, #0x0F
   5655 32 1C 52      [13]  884 	ld (animMuerto), a
   5658 C3 D8 52      [10]  885 	jp no_updatear
                            886 
   565B                     887 no_reviv:
                            888 
   565B 5F            [ 4]  889 	ld e, a
   565C 06 08         [ 7]  890 	ld b, #0x08
...
Hexadecimal [16-Bits]
   ...
   565E 90            [ 4]  891 	sub b
   565F 20 0D         [12]  892 	jr nz, dont_change_dead_sprite_hero
                            893 
                            894 	;;change sprite to second dying
   5661 01 5F 3E      [10]  895 	ld bc, #_hero_sp_7
   5664 21 1D 52      [10]  896 	ld hl, #hero_data
   5667 23            [ 6]  897 	inc hl
   5668 23            [ 6]  898 	inc hl
   5669 23            [ 6]  899 	inc hl
   566A 23            [ 6]  900 	inc hl
   566B 71            [ 7]  901 	ld (hl), c
   566C 23            [ 6]  902 	inc hl
   566D 70            [ 7]  903 	ld (hl), b
                            904 
   566E                     905 dont_change_dead_sprite_hero:
   566E 7B            [ 4]  906 	ld a, e
   566F 32 1C 52      [13]  907 	ld (animMuerto), a
                            908 
   5672 C3 D8 52      [10]  909 	jp no_updatear
