...
Hexadecimal [16-Bits]
                             ...
                             26 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             27 ;;;;;;;;;;;;;; INIT_WIN ;;;;;;;;;;;;;;
                             28 ;;;;;;;; Show final win screen;;;;;;;;
                             29 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             30 
   45F6                      31 init_win:
                             32 
   45F6 21 C9 42      [10]   33 	ld hl, #_menu_pack_end 	;;load here the tilemap you want
   45F9 CD 8B 4F      [17]   34 	call DecompressTilemap
                             35 
   45FC 3E C0         [ 7]   36 	ld a, #0xC0
   45FE CD E2 48      [17]   37 	call drawTileMap
                             38 
   4601 3E 80         [ 7]   39 	ld a, #0x80
   4603 CD E2 48      [17]   40 	call drawTileMap  
                             41 
   4606 3E C0         [ 7]   42 	ld a, #0xC0
   4608 CD 1F 46      [17]   43 	call draw_text_sp_win
                             44 
   460B 3E 80         [ 7]   45 	ld a, #0x80
   460D CD 1F 46      [17]   46 	call draw_text_sp_win
                             47 
   4610                      48 initeando_win:
                             49 
   4610 CD 8B 60      [17]   50 	call cpct_waitVSYNC_asm
                             51 
   4613 CD D1 61      [17]   52 	call cpct_scanKeyboard_asm 		;; Scan keyboard
   4616 21 07 80      [10]   53 	ld hl, #Key_X					;; Check X key
   4619 CD 9D 56      [17]   54 	call cpct_isKeyPressed_asm
                             55 
   461C 28 F2         [12]   56 	jr z, initeando_win
                             57 
                             58 
   461E C9            [10]   59 ret
                             60 
   461F                      61 draw_text_sp_win:
                             62 
   461F F5            [11]   63 	push af
                             64 
   4620 57            [ 4]   65 	ld     d, a
   4621 1E 00         [ 7]   66 	ld     e, #0
   4623 0E 14         [ 7]   67 	ld     c, #0x14         		;; C = Title X
   4625 06 30         [ 7]   68    	ld     b, #0x30         		;; B = Title Y
   4627 CD B5 61      [17]   69    	call cpct_getScreenPtr_asm
                             70 
   462A EB            [ 4]   71    	ex    de, hl   					;; DE = memory pointer
                             72 
   462B 21 DE 10      [10]   73 	ld hl, #_thanks_sp_0
   462E 06 3C         [ 7]   74    	ld  b, #0x3C 	;;height
   4630 0E 2B         [ 7]   75    	ld  c, #0x2B 	;;width
                             76 
   4632 CD EF 5E      [17]   77    	call cpct_drawSprite_asm
                             78 
   4635 F1            [10]   79    	pop af
...
Hexadecimal [16-Bits]
                             ...
                             80 
   4636 57            [ 4]   81    	ld     d, a
   4637 1E 00         [ 7]   82 	ld     e, #0
   4639 0E 14         [ 7]   83 	ld     c, #0x14         		;; C = Title X
   463B 06 80         [ 7]   84    	ld     b, #0x80         		;; B = Title Y
   463D CD B5 61      [17]   85    	call cpct_getScreenPtr_asm
                             86 
   4640 EB            [ 4]   87    	ex    de, hl   					;; DE = memory pointer
                             88 
   4641 21 F2 1A      [10]   89 	ld hl, #_thanks_sp_1
   4644 06 05         [ 7]   90    	ld  b, #0x05 	;;height
   4646 0E 2B         [ 7]   91    	ld  c, #0x2B 	;;width
                             92 
   4648 CD EF 5E      [17]   93    	call cpct_drawSprite_asm
   464B C9            [10]   94 ret
