...
Hexadecimal [16-Bits]
                             ...
                             26 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             27 ;;;;;;;;;;;; INIT_GAMEOVER ;;;;;;;;;;;;;;;;;;
                             28 ;;;;;; Show game over screen ;;;;;;;;;;;;;;;;
                             29 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             30 
   4742                      31 init_gameOver:
                             32 
   4742 21 C9 42      [10]   33 	ld hl, #_menu_pack_end 	;;load here the tilemap you want
   4745 CD 8B 4F      [17]   34 	call DecompressTilemap
                             35 
   4748 3E C0         [ 7]   36 	ld a, #0xC0
   474A CD E2 48      [17]   37 	call drawTileMap
                             38 
   474D 3E 80         [ 7]   39 	ld a, #0x80
   474F CD E2 48      [17]   40 	call drawTileMap  ;;call tilemap menu
                             41 
   4752 3E C0         [ 7]   42 	ld a, #0xC0
   4754 CD 6B 47      [17]   43 	call draw_text_sp
                             44 
   4757 3E 80         [ 7]   45 	ld a, #0x80
   4759 CD 6B 47      [17]   46 	call draw_text_sp
                             47 
   475C                      48 initeando:
                             49 
   475C CD 8B 60      [17]   50 	call cpct_waitVSYNC_asm
                             51 
   475F CD D1 61      [17]   52 	call cpct_scanKeyboard_asm 		;; scan keyboard
   4762 21 05 80      [10]   53 	ld hl, #Key_Space				;; Check Space key
   4765 CD 9D 56      [17]   54 	call cpct_isKeyPressed_asm
                             55 
   4768 28 F2         [12]   56 	jr z, initeando
                             57 
                             58 
   476A C9            [10]   59 ret
                             60 
                             61 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             62 ;;;;;;;;;;; DRAW_TEXT_SP;;;;;;;;;;;;;;;;
                             63 ;;;;; Draw sprite game over screen ;;;;;
                             64 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             65 
   476B                      66 draw_text_sp:
                             67 
   476B F5            [11]   68 	push af
                             69 
   476C 57            [ 4]   70 	ld     d, a
   476D 1E 00         [ 7]   71 	ld     e, #0
   476F 0E 14         [ 7]   72 	ld     c, #0x14         		;; C = Title X
   4771 06 40         [ 7]   73    	ld     b, #0x40         		;; B = Title Y
   4773 CD B5 61      [17]   74    	call cpct_getScreenPtr_asm
                             75 
   4776 EB            [ 4]   76    	ex    de, hl   					;; DE = memory pointer
                             77 
   4777 21 D4 09      [10]   78 	ld hl, #_gameover_text_sp_0
   477A 06 1A         [ 7]   79    	ld  b, #0x1A	;;height
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   477C 0E 28         [ 7]   80    	ld  c, #0x28 	;;width
                             81 
   477E CD EF 5E      [17]   82    	call cpct_drawSprite_asm
                             83 
   4781 F1            [10]   84    	pop af
                             85 
   4782 57            [ 4]   86    	ld     d, a
   4783 1E 00         [ 7]   87 	ld     e, #0
   4785 0E 14         [ 7]   88 	ld     c, #0x14         		;; C = Title X
   4787 06 70         [ 7]   89    	ld     b, #0x70         		;; B = Title Y
   4789 CD B5 61      [17]   90    	call cpct_getScreenPtr_asm
                             91 
   478C EB            [ 4]   92    	ex    de, hl   					;; DE = memory pointer
                             93 
   478D 21 E4 0D      [10]   94 	ld hl, #_gameover_text_sp_1
   4790 06 0D         [ 7]   95    	ld  b, #0x0D;; alto
   4792 0E 28         [ 7]   96    	ld  c, #0x28;; Ancho
                             97 
   4794 CD EF 5E      [17]   98    	call cpct_drawSprite_asm
   4797 C9            [10]   99 ret
