...
$(eval $(call ADD2PACK,level0_pack,src/tiles/level0.bin))
$(eval $(call ADD2PACK,level0_pack,src/tiles/Tileset.bin))
$(eval $(call PACKZX7B,level0_pack,src/))
$(eval $(call ADD2PACK,menu_pack,src/tiles/menu.bin))
$(eval $(call ADD2PACK,menu_pack,src/tiles/Tileset.bin))
$(eval $(call PACKZX7B,menu_pack,src/))
$(eval $(call ADD2PACK,menu2_pack,src/tiles/menu2.bin))
$(eval $(call ADD2PACK,menu2_pack,src/tiles/Tileset.bin))
$(eval $(call PACKZX7B,menu2_pack,src/))
